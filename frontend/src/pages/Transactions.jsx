      ...
      {partial && (
        <div style={{ padding: 'var(--space-sm) var(--space-md) 0' }}>
          <Notice kind="warn">
            ...
            from the {fmtInt(partial.rows)} transactions stored here. The backend last
            ...
            <div className="filter-block">
              ...
              <Select
                ...
                options={[
                  ...
                  { value: 'txid:asc', label: 'TXID, ascending' },
                ]}
              />
            </div>
